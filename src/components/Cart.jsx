...
const Cart = () => {
    ...
    return (
        ...
        <div className='font-pro flex items-center '>
            ...
            {!cartOpen && (
                    <div className='absolute h-5 w-5 mt-6 bg-red-500 text-white rounded-full flex items-center justify-center font-bold font-pro text-[12px] '>{cartItems.length}</div>
                )}

                <div className=''>
                
                    {!cartOpen ? <AiOutlineShoppingCart className='h-8 w-8 mb-5 text-[#C8A178]' />
